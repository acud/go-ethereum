...
type Header struct {
	ParentHash  common.Hash    `json:"parentHash"       gencodec:"required" bson:"parentHash"         `
	UncleHash   common.Hash    `json:"sha3Uncles"       gencodec:"required" bson:"sha3Uncles"       `
	Coinbase    common.Address `json:"miner"                               bson:"miner"`
	Root        common.Hash    `json:"stateRoot"        gencodec:"required" bson:"stateRoot"        `
	TxHash      common.Hash    `json:"transactionsRoot" gencodec:"required" bson:"transactionsRoot" `
	ReceiptHash common.Hash    `json:"receiptsRoot"     gencodec:"required" bson:"receiptsRoot"     `
	Bloom       Bloom          `json:"logsBloom"        gencodec:"required" bson:"logsBloom"        `
	Difficulty  *big.Int       `json:"difficulty"       gencodec:"required" bson:"difficulty"       `
	Number      *big.Int       `json:"number"           gencodec:"required" bson:"number"           `
	GasLimit    uint64         `json:"gasLimit"         gencodec:"required" bson:"gasLimit"         `
	GasUsed     uint64         `json:"gasUsed"          gencodec:"required" bson:"gasUsed"          `
	Time        uint64         `json:"timestamp"        gencodec:"required" bson:"timestamp"        `
	Extra       []byte         `json:"extraData"        gencodec:"required" bson:"extraData"        `
	MixDigest   common.Hash    `json:"mixHash" json:"mixHash"`
	Nonce       BlockNonce     `json:"nonce" json:"nonce"`
